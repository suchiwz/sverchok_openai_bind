...
class SvOpenAIFunctionCallNode(bpy.types.Node, SverchCustomTreeNode):
    """
    A custom node that interacts with OpenAI's API
    call the openai chat completion method for function calling
    ...
    bl_idname = 'SvOpenAIFunctionCallNode'
    bl_label = 'OpenAI Function Call Node'
